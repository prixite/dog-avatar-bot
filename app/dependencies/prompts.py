def three_tokens_prompt(docs,extracted_currency_data,coin_symbol,currency_name,currency_name2,currency_name3,price_coin,price_coin2,price_coin3):
    prompt=[
            {
                "role": "system",
...
def two_tokens_prompt(docs,extracted_currency_data,currency_name,currency_name2,coin_symbol,price_coin,price_coin2):
    prompt=[
            {
                "role": "system",
                "content": f""" I am going to provide you Historical_currency_price_data in json format that contains information about a crypto currency and its historical data. Also a few Information_hex_pulse documents.\n
...
def four_tokens_prompt(docs,extracted_currency_data,coin_symbol,currency_name,currency_name2,currency_name3,currency_name4,price_coin,price_coin2,price_coin3,price_coin4):
    prompt=[
            {
                "role": "system",
                "content": f""" I am going to provide you Historical_currency_price_data in json format that contains information about a crypto currency and its historical data. Also a few Information_hex_pulse documents.\n
